...
const intakeFormsRoutes = require('./routes/intakeForms-mongodb');
const submissionsRoutes = require('./routes/submissions-mongodb');
const programsRoutes = require('./routes/programs-mongodb');
const analyticsRoutes = require('./routes/analytics-mongodb');
const referralsRoutes = require('./routes/referrals');
const projectsRoutes = require('./routes/projects-mongodb');
const customApplicationsRoutes = require('./routes/customApplications-mongodb');
const staticPagesRoutes = require('./routes/staticPages-mongodb');
...
app.use(`${BASE_PATH}/submissions`, submissionsRoutes);
