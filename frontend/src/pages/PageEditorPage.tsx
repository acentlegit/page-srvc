...
export default function PageEditorPage() {
  ...
  const downloadTemplate = () => {
    ...
    const sampleLines: Record<string, string[]> = {
      admin: ['page-one,Sample description,high', 'page-two,Another description,low'],
      manager: ['page-one,Sample description,alex@beam.com', 'page-two,Another description,priya@beam.com'],
      dispatcher: ['page-one,Sample description,dispatch-queue-a', 'page-two,Another description,dispatch-queue-b'],
      generic: ['page-one,Sample description', 'page-two,Another description'],
    }
    const lines = sampleLines[role] ?? sampleLines.generic
  ...
  const handleUpload = async (file: File | null) => {
    ...
    reader.onload = async () => {
      ...
      try {
        ...
        const newRows: PageRow[] = createdPages.map((page: PageModel) => ({
          id: page.id,
          name: page.name,
          description: page.content?.heroTitle || page.content?.description || '',
          createdAt: new Date(page.createdAt).toLocaleDateString(),
